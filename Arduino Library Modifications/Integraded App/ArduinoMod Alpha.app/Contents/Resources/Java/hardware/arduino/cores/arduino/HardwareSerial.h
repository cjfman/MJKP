...
class MPCMHardwareSerial// : public Stream
{
  private:
	ring_buffer *_MPCM_rx_buffer;
	volatile uint8_t *_ubrrh;
	volatile uint8_t *_ubrrl;
	volatile uint8_t *_ucsra;
	volatile uint8_t *_ucsrb;
	...
	//bool _master;
  public:
    MPCMHardwareSerial(ring_buffer *MPCM_rx_buffer,
	  volatile uint8_t *ubrrh, volatile uint8_t *ubrrl,
	  volatile uint8_t *ucsra, volatile uint8_t *ucsrb,
	  volatile uint8_t *udr,
    ...
    virtual void writeMode(uint8_t);
//	void print(String);
//	void print(char);
//	void print(char[]);
...
#if defined(UBRRH) || defined(UBRR0H)
  extern MPCMHardwareSerial MPCMSerial;
#elif defined(USBCON)
  #include "usb_api.h"
#endif
#if defined(UBRR1H)
  extern MPCMHardwareSerial MPCMSerial1;
#endif
#if defined(UBRR2H)
  extern MPCMHardwareSerial MPCMSerial2;
#endif
#if defined(UBRR3H)
  extern MPCMHardwareSerial MPCMSerial3;
#endif
